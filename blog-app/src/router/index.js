  ...
  routes: [
    ...
    
    {
      ...
      children: [
        ...
        {
          path: '/collectDetil/:collectId',
          component: r => require.ensure([], () => r(require('@/views/person/CollectDetil')), 'collectDetil')
        },
        {
          path: '/personInfo/:id',
          component: r => require.ensure([], () => r(require('@/views/person/personInfo')), 'personInfo')
        },
        {
          path: '/view/:id',
        ...
        {
          path: '/person',
          component: r => require.ensure([], () => r(require('@/views/person/person')), 'me')
        },
        {
          path: '/:type/:id',
