...
public class UserController {
    ...
    @LogAnnotation(module = "用户", operation = "根据id获取用户信息")
    public Result getUserInfos(@PathVariable("id") Long id) {
        Result r = new Result();
        if (null == id) {
            r.setResultCode(ResultCode.PARAM_IS_BLANK);
            return r;
    ...
    @LogAnnotation(module = "用户", operation = "删除用户")
    public Result updateUserInfo(User user,Userinfo userinfo) {
        Result r = new Result();
